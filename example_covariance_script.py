...
### angular correlation function and covariance from the import of chomp down to
### writing of the values. This example uses the correlation induced from 
### galaxy-galaxy magnification as the example, however any correlation 
### currently available or created by the user (assuming it conforms to the
### template class) could be used.
...
### Now we need to create a covariance object. This takes as input two
...
### write the results.
cov.get_covariance()
cov.write('test_covariance.ascii')
...
### corr.set_hod, and reinitialize the covariance (in this case) to change the 
### cosmology/HOD and recompute.
